...
const searchInput = document.getElementById("search-input");
    ...
    // Markup kartu ada di js/site-donghua-card.js supaya halaman
    // beranda/post/favorit tidak perlu memuat seluruh mesin pencarian.
    ...
    function renderResults() {
      ...
      pageItems.forEach(({ item, matches }) => {
        ...
        if (typeof cardFactory !== "function") return;
        li.innerHTML = cardFactory(item, title, metaStr, 2);
